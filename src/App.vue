...
const items = ref([
  {id: 1, label: 'Yogurt Griego', purchased: false, highPriority: false },
  {id: 2, label: 'Leche Santa Clara', purchased: true, highPriority: true },
  {id: 3, label: 'Queso Panela', purchased: true, highPriority: false },
  {id: 4, label: 'Jarrito de Piña', purchased: false, highPriority: true },
  {id: 5, label: 'Paquete de Salchichas', purchased: true, highPriority: false }
...
<template>
  <div class="header">
    ...
    <button v-else @click="doEdit(true)" class="btn btn-primary">Añadir Articulo</button>
  </div>
